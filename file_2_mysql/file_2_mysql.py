...
with DAG(
    ...
    if not shutil.which("virtualenv"):
        ...
        #sleeping_task >> virtualenv_task >> sleeping_task
        ...
        # [START validate_data]
        validate_data = ExternalPythonOperator(
        ...
        transform_data = ExternalPythonOperator(
        ...
        load_data = ExternalPythonOperator(
            task_id="load_data",                                                                                                                                         # [START howto_operator_python_venv_classic]
            python=PATH_TO_PYTHON_BINARY,                                                                                                                                     #virtual_classic = PythonVirtualenvOperator(
            python_callable=x,                                                                                                                                                #    task_id="virtualenv_classic",
        ...
        ingest_file_task >> validate_data >> transform_data >> load_data
